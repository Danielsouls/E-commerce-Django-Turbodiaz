...
from django.utils.timezone import now  # Import necesario para establecer la hora actual
...
class OrdenDeCompra(models.Model):
    ...
    #paso 1 opcional 
    envio_a_regiones = models.CharField(
        max_length=50, 
        choices=[('Starken', 'Starken'), ('Chilexpress', 'Chilexpress'), ('CorreosChile', 'CorreosChile')], 
        default=''
    )
    rut = models.CharField(max_length=12, default='', blank=True, null=True)

    fecha = models.DateField(auto_now=True, null=True, blank=True)
    fecha_emision = models.DateTimeField(default=now, null=True, blank=True)
